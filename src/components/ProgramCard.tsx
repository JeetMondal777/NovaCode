...
const ProgramCard = ({
  ...
  return (
    <motion.div
      ...
      className="h-full"
    >
      <Card className="overflow-hidden border-none h-full shadow-lg bg-white relative">
        {popular && (
        ...
        <CardHeader className="bg-gradient-to-r from-novacode-purple/10 to-novacode-lightpurple/10 pb-4">
          <div className="space-y-2">
            {popular && <Badge className="bg-novacode-purple text-white border-none mb-1">Most Popular</Badge>}
            <h3 className="font-heading text-2xl font-bold text-gray-800">{title}</h3>
        ...
        <CardFooter className="border-t pt-4 pb-5 bg-gray-50">
          <Button 
            ...
            className="w-full bg-gradient-to-r from-novacode-purple to-novacode-darkpurple hover:opacity-90 transition-opacity"
          >
            Apply Now
          </Button>
        </CardFooter>
